...
#print(100*((float(tablecells[5].text)-float(tablecells[6].text))/float(tablecells[6].text)))
...
for x in range(5):
    ...
    print(name)
    print(f"Percent Change on Web Page: {change}")
    print(f"High: {high}")
    print(f"Low: {low}")
    print(f"Calculated change percent: {calc_change}%")
    print()
    print()
    counter+=11
